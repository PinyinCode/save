...
@media (min-width:769px) and (max-height:550px){.practice-full-header{padding:.3rem .85rem}.practice-full-header .pf-tags{display:none}.pf-filters{padding:.25rem .85rem .2rem}.pf-search-wrap{display:none}.pf-quick-nav{margin-top:0}.practice-full-body{padding:.5rem .6rem}.practice-full-content{gap:.5rem}.practice-full-vi{font-size:1.1rem;padding:.55rem .5rem}.practice-full-input{font-size:1.15rem;padding:.55rem .8rem}.char-slot{font-size:1.1rem;min-width:1.25rem;height:1.6rem}.practice-full-nav{padding:.4rem .65rem}.pf-nav-btn{padding:.45rem .6rem;font-size:.75rem}}
